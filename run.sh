...
STATEMENT_ID=$(md5 -qs "SID-$WERCKER_LAMBDA_ADD_PERMISSION_FUNCTION_NAME+$WERCKER_LAMBDA_ADD_PERMISSION_ACTION+$WERCKER_LAMBDA_ADD_PERMISSION_PRINCIPAL+$WERCKER_LAMBDA_ADD_PERMISSION_SOURCE_ARN")
set +e
